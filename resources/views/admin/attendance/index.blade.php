                                            ...
                                            @foreach($student as $key=> $students)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="radio" name="attendence[{{ $students->id }}]" value="1" required="" checked="checked" > Present
                                                        <input type="radio" name="attendence[{{ $students->id }}]" value="2">Absence
                                                        <input type="radio" name="attendence[{{ $students->id }}]" value="3">Late
                                                    </td>
