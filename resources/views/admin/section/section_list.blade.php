...
<div class="col-lg-12 col-md-12 col-sm-8 col-xs-12" style="margin-top: 36px;">
    <div class="sparkline10-list mt-b-30">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <select class="form-control" name="class_id" id="class_id" required>
                                                <option value="" >Serch Section</option>
                                        ...
                                        <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12">
                                            <a class="btn btn-md btn-primary login-submit-cs" data-toggle="modal" data-target="#PrimaryModalhdbgcl" style="height: 39px;padding: 10px;"><i class="fa fa-plus"></i> Create Section</a>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name">Section name</th>
                                                <th data-field="name">Class name</th>
                                                <th data-field="roll">Section Teacher</th>
        ...
        @include('admin.section.section_form')
...
<script>
    $("#class_id").change(function(){
           ...
           var id = $(this).val();
            if(id){
                $.get("{{ route('admin.section.list.by.ajax')}}", {id:id}, function(data){
                    $("#overlay .loader").hide();
